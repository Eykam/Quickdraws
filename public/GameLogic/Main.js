...
socket.on("roundWinner", (data) => {
    ...
    if(data['roundWinner'] === leftPlayer['clientID']){
        setShot("left");
        setDead("right");
        winnerInfo.innerText = leftPlayer['username'] + "#" + data['roundWinner'] + " won this round!";
    }
    else{
        setShot("right");
        setDead("left");
        winnerInfo.innerText =rightPlayer['username'] + "#" + data['roundWinner'] + " won this round!";
    }
    ...
    console.log("Round " + data["currRound"] + " Winner: ", data["roundWinner"]+ "#" +clientID);
